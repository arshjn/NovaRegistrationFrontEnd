...
We accomplished this by storing the information on a MySQL database and creating web APIs both of which were hosted on Amazon Web Services, and having the front-end Swift application call these API’s and get both student and dorm information from the database as well as update the database tables with new information when reserving a room. 
...
On click of sign in button, we call the Sign in button and it checks your creditials and either signs you in or returns false. 
